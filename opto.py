...
def objective(trial):
    ...
    # use this next
    a0 = trial.suggest_float("alpha_1_rot_rot",     0.25, 0.70)
    a1 = trial.suggest_float("alpha_2_rot_trans",   0.04, 0.16)
    a2 = trial.suggest_float("alpha_3_trans_trans", 0.55, 1.20)
    a3 = trial.suggest_float("alpha_4_trans_rot",   0.12, 0.35)

    r_dist = trial.suggest_float("r_noise_dist", 0.20, 0.65)
    r_ang  = trial.suggest_float("r_noise_ang",  0.15, 0.50)
